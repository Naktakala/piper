#ifndef CHITECH_LAYEREDVOLUMEAVERAGE_H
#define CHITECH_LAYEREDVOLUMEAVERAGE_H
...
class LayeredVolumeAverage
  : public DerivedObject,
    public chi_physics::GridBasedFieldFunctionInterface
{
public:
  static InputParameters GetInputParameters();
  explicit LayeredVolumeAverage(const InputParameters& params);
...
#endif // CHITECH_LAYEREDVOLUMEAVERAGE_H
